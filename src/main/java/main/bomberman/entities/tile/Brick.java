...
public class Brick extends AnimatedImage {
    ...
    private Item item;
    private int timeOff = 0;        //thời gian gạch đã bị vỡ

    /**
     * tạo gạch mặc định(không có gì bên trong, địa điểm mặc định)
     * */
    public Brick() {
        isDestroyed = false;
